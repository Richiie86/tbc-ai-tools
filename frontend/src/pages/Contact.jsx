    ...
    <div className="min-h-screen bg-slate-950">
      ...
      <section className="mx-auto max-w-6xl px-5 py-20">
        <div className="grid gap-12 md:grid-cols-2">
          <div>
            <div className="text-xs font-semibold uppercase tracking-[0.2em] text-emerald-400">Get in touch</div>
          ...
          <form onSubmit={submit} className="rounded-2xl border border-slate-800 bg-slate-900/60 p-7">
            <div className="grid gap-4">
              ...
              <Button type="submit" disabled={submitting} className="bg-emerald-500 text-slate-950 hover:bg-emerald-400 font-semibold">
