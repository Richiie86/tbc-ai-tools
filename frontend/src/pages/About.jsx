  ...
  return (
    <div className="min-h-screen bg-slate-950">
      ...
      <section className="mx-auto max-w-5xl px-5 py-20">
        <div className="text-xs font-semibold uppercase tracking-[0.2em] text-emerald-400">About TBC AI Control</div>
        ...
        <div className="mt-20">
          ...
          <p className="mt-3 max-w-3xl text-slate-400">
            TradeBridge Club operators ship and maintain TBC AI Control with a small senior team focused on
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-3">
            {[
              ...
              <div key={p.name} className="rounded-2xl border border-slate-800 bg-slate-900/60 p-6">
                <div className="grid h-12 w-12 place-items-center rounded-full bg-emerald-500/20 text-lg font-bold text-emerald-300">{p.name.split(' ').map((s)=>s[0]).join('')}</div>
