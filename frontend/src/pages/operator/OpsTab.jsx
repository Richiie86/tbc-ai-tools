...
export default function OpsTab() {
  ...
  return (
    <div className="grid gap-6" data-testid="ops-tab">
      {/* === QUICK ACTIONS (neon indigo) === */}
      <section>
        <div className="grid gap-3 sm:grid-cols-3">
          {/* Run Health Check — medium indigo */}
          <button
          ...
          >
            ...
            <div className="relative flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-[11px] text-indigo-100/80">{health ? `${health.summary.passing}/${health.summary.total} passing` : 'tap to scan'}</div>
              </div>
            </div>
          </button>

          {/* Run Code Review — darker indigo */}
          <button
          ...
          {/* Re-deploy Changes — brightest neon indigo, opens Emergent deploy page */}
          <a
