      ...
      <div className="mx-auto max-w-md px-5 py-16">
        <div className="rounded-2xl border border-slate-800 bg-slate-900/60 p-8">
          ...
          <form onSubmit={submit} className="mt-7 space-y-4">
            <Input maxLength={6} className="border-slate-700 bg-slate-950 text-center text-3xl tracking-[0.4em] text-emerald-200" value={code} onChange={(e)=>setCode(e.target.value.replace(/\D/g,''))} placeholder="••••••" autoFocus />
            <Button disabled={loading} className="w-full bg-emerald-500 text-slate-950 hover:bg-emerald-400 font-semibold">
